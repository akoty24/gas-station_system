...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-header with-border text-center">
            <h3 class="box-title" style="">{{ trans('backend.software_settings') }} </h3>
        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="imagePreview">
                                <img style="width:100%;height:240px;margin-top:5px;object-fit:contain" class="image-preview img-thumbnail" src="{{ asset('uploads/admins/default.png') }}" alt="">
                            </div>
